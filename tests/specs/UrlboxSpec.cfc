	...
	function run(){
      ...
      it("generates a jpg format url correctly", function(){
        ...
        var result = urlbox.buildUrl( 'example.com', options );
				expect( result ).toBe( 'https://api.urlbox.io/v1/API_KEY/b1b9b4362a5044ff18718d4d9a961044ed0cc815/jpg?url=example.com' );
			});
